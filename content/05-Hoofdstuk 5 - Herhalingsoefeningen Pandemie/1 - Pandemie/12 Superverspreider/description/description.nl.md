...
* Als de score minstens 9 is, telt die persoon als `superverspreider` en besmet die 25 extra personen.
...
Elke persoon krijgt een score. Bij `score >= 9` tel je 25 extra besmettingen. Anders tel je alleen het gewone aantal besmettingen. Tel alle nieuwe besmettingen samen in `nieuwe_besmettingen`.
